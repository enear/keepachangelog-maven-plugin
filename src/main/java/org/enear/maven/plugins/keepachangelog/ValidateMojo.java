...
import org.enear.maven.plugins.keepachangelog.markdown.specific.ChangelogValidator;

import java.nio.file.Path;
import java.util.Set;

import static org.enear.maven.plugins.keepachangelog.git.TagUtils.toTag;
